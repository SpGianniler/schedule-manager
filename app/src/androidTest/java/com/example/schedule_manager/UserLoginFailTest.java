...
public class UserLoginFailTest {
    ...
    public void userLoginFailTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextEmailUser), withText("aaa"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editTextPasswordUser), withText("aaa"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textLogUser), withText("Login"),
