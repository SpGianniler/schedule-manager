...
public class AdminLoginFailTest {
    ...
    public void adminLoginFailTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextEmailAdmin), withText("aaa"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editTextPasswordAdmin), withText("aaa"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textLogAdmin), withText("Login"),
