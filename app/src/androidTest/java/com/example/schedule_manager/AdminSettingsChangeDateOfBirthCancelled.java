...
public class AdminSettingsChangeDateOfBirthCancelled {

    @Rule
    public ActivityScenarioRule<MainActivity> mActivityTestRule = new ActivityScenarioRule<>(MainActivity.class);

    @Test
    public void adminSettingsChangeDateOfBirthCancelled() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.AdminSettingsChosenDOBText), withText("Date of Birth"),
                        withParent(withParent(withId(R.id.tableLayout))),
                        isDisplayed()));
        textView.check(matches(withText("Date of Birth")));
    }
