/**
 * η κλάση αυτή περιγράφει μία βαρδια
 * αποτελείται από
 * ονομα βάρδιας (πρωι μεσημερι απογευμα βραδυ κλπ)
 * ονομα ειδικότητας(μηχανικοι, γραμματεια κλπ)
 * και αριθμό εργαζόμενων που απαιτείται για την βάρδια αυτη στη συγκεκριμένη ειδικότητα
 */
